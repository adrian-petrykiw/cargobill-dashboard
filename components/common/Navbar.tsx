...
const navigation = [
  ...
  { name: 'Banking', href: ROUTES.BANKING },
  { name: 'Organizations', href: ROUTES.ORGANIZATIONS.LIST },
];
            ...
            <div className="flex h-16 justify-between">
              <div className="flex">
                <div className="flex flex-shrink-0 items-center">
                  ...
                  />
                  <span className="ml-2 text-xl font-semibold text-gray-900">CargoBill</span>
                </div>
